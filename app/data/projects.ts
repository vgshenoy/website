...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: `<p><a href="https://github.com/shenoy/vue-scrollama" target="_blank">Vue-Scrollama</a> is an open source Vue component to easily setup scroll-driven interactions (aka scrollytelling) on the web.</p>`,
    info: [
      {
        heading: 'Links',
  ...
  },
  {
    ...
    roles: ['prototyping'],
    desc: `<p><a href="https://indiahikes.com" target="_blank">Indiahikes</a> is India's largest trekking community - they run over 20 treks in various ranges of the Himalayas, drive conservation efforts and undertake outdoor education programmes.</p>
  ...
  },
  {
    ...
    roles: ['full stack engineering', 'prototyping'],
    desc: `<p>In 2014, Google partnered with <a href="https://airtel.com" target="_blank">Airtel</a> to bring the <a href="https://store.google.com/us/product/chromecast" target="_blank">Chromecast</a> to the Indian market. Gida worked on building an online experience for the launch.</p>
      <p>Leveraging websocket protocols, we built an immersive web experience that allowed visitors to control video playback on desktop browsers from their smartphones, thereby simulating the 'magic' and convenience of the casting experience.</p>`,
    info: [
      {
        heading: 'Links',
