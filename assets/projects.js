...
export default [
    ...
    info: [
      {
        heading: 'Links',
        content:
          '<a href="http://shapeofthegame.com" target="_blank">Website</a>',
      },
      {
        heading: 'Period',
  ...
  },
  {
    ...
    slides: [
      {
        img: nostraImg1,
        text: 'The core of the game is answering questions about player/team performance to get points if your predictions turn out correct. You can then see your position on a leaderboard of other players or friends and win prizes if you join a paid contest.',
      },
      {
        img: nostraImg2,
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        heading: 'With',
        content:
          '<a href="http://indiahikes.com" target="_blank">Indiahikes</a>',
      },
      {
        heading: 'Period',
  ...
  },
  {
    ...
    shortDesc:
      'is a web app for DEN Networks to track and monitor rollout of their broadband network across India',
    ...
    info: [
      {
        heading: 'Links',
        content:
          '<a href="https://web.archive.org/web/20150625151013/http://chromecast.airtel.in/#home" target="_blank">Archived Link</a>',
      },
      {
        heading: 'With',
        content:
